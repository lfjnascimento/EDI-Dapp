...
export function generateDegreePDF(degree, courses){
  ...
  const middleText2 = `${course.degreeType.toUpperCase()} em ${course.name.toUpperCase()} a`;
  ...
  a fim de que possa gozar todos os direitos e prerrogativas legais.`;
  ...
  doc.setFontSize(14);
  doc.text(middleText4, 15, 14, {align: 'center', maxWidth: 25});
